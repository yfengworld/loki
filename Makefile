...
#-----------library
#libev
LIBEV_DIR=deps/libev
LIBEV_INC=$(LIBEV_DIR)
LIBEV_STATICLIB=$(LIBEV_DIR)/libev.a
...
SRC_PATH = silly-src
LIB_PATH = lualib-src
INCLUDE = -I $(LIBEV_INC) -I $(LUA_INC) -I $(JEMALLOC_INC) -I $(SRC_PATH)
SRC_FILE = \
      main.c \
      silly_socket.c \
      silly_queue.c \
...
$(TARGET):$(OBJS) $(LIBEV_STATICLIB) $(LUA_STATICLIB) $(MALLOC_STATICLIB)
	$(LD) -o $@ $^ $(LDFLAG)
